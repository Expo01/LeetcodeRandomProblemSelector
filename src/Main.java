...
//        problems.add(new Pair(704,"binary search"));
        problems.add(new Pair(733,"flood fill"));
...
//        problems.add(new Pair(217,"contains duplicate"));
...
//        problems.add(new Pair(283,"move zeros"));
...
//        removeAndStore(7,problems,learned);
    }
    ...
    private static void removeAndStore(int index, ArrayList<Pair> problems, ArrayList<Pair> learned){
        ...
        learned.add(temp);
        System.out.println("problem # " + temp.getProblemNumber() + " : "
                + temp.getProblemName() + " added to learned list");
    }
}
